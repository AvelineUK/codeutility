document.addEventListener('DOMContentLoaded', () => {
    ...
    async function formatCode() {
        ...
        if (!input.trim()) {
            showToast('Please enter some JavaScript code to format');
            return;
        }
        ...
        try {
            const formatted = await prettier.format(input, {
                ...
                semi: semicolons.checked,
                singleQuote: singleQuote.checked,
                trailingComma: trailingComma.checked ? 'es5' : 'none',
                printWidth: 80,
                arrowParens: 'avoid'
            });
            ...
            showToast('Error: Invalid JavaScript syntax - ' + error.message);
        }
    }
