document.addEventListener('DOMContentLoaded', () => {
    ...
    const copySha512 = document.getElementById('copySha512');
    ...
    generateBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            const sha1Hash = await generateHash(input, 'SHA-1');
    ...
    // Copy buttons
    copyMd5.addEventListener('click', () => copyToClipboard(md5Output.value, copyMd5));
    copySha1.addEventListener('click', () => copyToClipboard(sha1Output.value, copySha1));
    copySha256.addEventListener('click', () => copyToClipboard(sha256Output.value, copySha256));
    copySha512.addEventListener('click', () => copyToClipboard(sha512Output.value, copySha512));
    ...
    // MD5 implementation (Web Crypto API doesn't support MD5, so we use a simple implementation)
